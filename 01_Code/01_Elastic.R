  ...
  ## Función de pre-procesamiento  pre_process_personas
  ...
  # Crear nueva columnas de a base de los datos correspondientes
  ...
  ## Se cruzan las tabla de test_personas con test_personas_hogar
